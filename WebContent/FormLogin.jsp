...
<form action="LoginServlet" class="login">
		...
		<p><input type="text"  class="login-input" name="email" placeholder="Email Adress" value="Username" onBlur="if(this.value == '') this.value = 'Username'" onFocus="if(this.value == 'Username') this.value = ''" required></p> <!-- JS because of IE support; better: placeholder="Username" -->
